...
class RelocationTest extends Specification {
    ...
    static final String MIRRORS_INITSCRIPT_PROPERTY = "org.gradle.smoketests.mirror.init.script"
    ...
    def setup() {
        ...
        mirrorsInitScript = System.getProperty(MIRRORS_INITSCRIPT_PROPERTY)
    }
    ...
    def expectedResults() {
        ...
        builder.put(':santa-tracker:checkDevelopmentDebugClasspath', FROM_CACHE)
        builder.put(':santa-tracker:checkDevelopmentDebugLibraries', FROM_CACHE)
        builder.put(':santa-tracker:checkDevelopmentDebugManifest', SUCCESS)
        builder.put(':santa-tracker:checkProductionDebugClasspath', FROM_CACHE)
        builder.put(':santa-tracker:checkProductionDebugLibraries', FROM_CACHE)
        ...
        builder.put(':wearable:checkDebugClasspath', FROM_CACHE)
        builder.put(':wearable:checkDebugLibraries', FROM_CACHE)
