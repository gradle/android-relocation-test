...
class RelocationTest extends Specification {
    ...
    def expectedResults() {
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':common:generateDebugBuildConfig', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':common:processDebugManifest', SUCCESS)
        ...
        builder.put(':dasherdancer:bundleDebugAar', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':dasherdancer:processDebugManifest', SUCCESS)
        ...
        builder.put(':doodles:bundleDebugAar', SUCCESS)
        builder.put(':doodles:checkDebugManifest', SUCCESS)
        builder.put(':doodles:compileDebugAidl', NO_SOURCE)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':doodles:processDebugManifest', SUCCESS)
        ...
        builder.put(':presentquest:bundleDebugAar', SUCCESS)
        builder.put(':presentquest:checkDebugManifest', SUCCESS)
        builder.put(':presentquest:compileDebugAidl', NO_SOURCE)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':presentquest:processDebugManifest', SUCCESS)
        ...
        builder.put(':rocketsleigh:bundleDebugAar', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':rocketsleigh:processDebugManifest', SUCCESS)
        ...
        builder.put(':santa-tracker:compileDevelopmentDebugAidl', NO_SOURCE)
        ...
        builder.put(':santa-tracker:compileProductionDebugAidl', NO_SOURCE)
        ...
        builder.put(':santa-tracker:createDevelopmentDebugCompatibleScreenManifests', SUCCESS)
        builder.put(':santa-tracker:createProductionDebugCompatibleScreenManifests', SUCCESS)
        builder.put(':santa-tracker:generateDevelopmentDebugAssets', UP_TO_DATE)
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':santa-tracker:generateDevelopmentDebugBuildConfig', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':santa-tracker:generateProductionDebugBuildConfig', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/123239721
        builder.put(':santa-tracker:mergeDexProductionDebug', SUCCESS)
        builder.put(':santa-tracker:mergeExtDexDevelopmentDebug', FROM_CACHE)
        builder.put(':santa-tracker:mergeExtDexProductionDebug', FROM_CACHE)
        builder.put(':santa-tracker:mergeLibDexDevelopmentDebug', FROM_CACHE)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/123239721
        builder.put(':santa-tracker:mergeProjectDexDevelopmentDebug', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':santa-tracker:processDevelopmentDebugManifest', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':santa-tracker:processProductionDebugManifest', SUCCESS)
        builder.put(':santa-tracker:processProductionDebugResources', FROM_CACHE)
        builder.put(':santa-tracker:signingConfigWriterDevelopmentDebug', SUCCESS)
        builder.put(':santa-tracker:signingConfigWriterProductionDebug', SUCCESS)
        ...
        builder.put(':snowdown:bundleDebugAar', SUCCESS)
        builder.put(':snowdown:checkDebugManifest', SUCCESS)
        builder.put(':snowdown:compileDebugAidl', NO_SOURCE)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':snowdown:processDebugManifest', SUCCESS)
        ...
        builder.put(':village:bundleDebugAar', SUCCESS)
        builder.put(':village:checkDebugManifest', SUCCESS)
        builder.put(':village:compileDebugAidl', NO_SOURCE)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':village:processDebugManifest', SUCCESS)
        ...
        builder.put(':wearable:createDebugCompatibleScreenManifests', SUCCESS)
        builder.put(':wearable:generateDebugAssets', UP_TO_DATE)
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':wearable:generateDebugBuildConfig', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/123239721
        builder.put(':wearable:mergeDexDebug', SUCCESS)
        ...
        // Should be FROM_CACHE - https://issuetracker.google.com/issues/120414109
        builder.put(':wearable:processDebugManifest', SUCCESS)
        builder.put(':wearable:processDebugResources', FROM_CACHE)
        builder.put(':wearable:signingConfigWriterDebug', SUCCESS)
